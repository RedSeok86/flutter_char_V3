...
mixin _$LoginStore on LoginStoreBase, Store {
  ...
  final _$getUserIdAsyncAction = AsyncAction('LoginStoreBase.getUserId');
  ...
  final _$getUserProfileAsyncAction =
      AsyncAction('LoginStoreBase.getUserProfile');

  @override
  Future<List<dynamic>> getUserProfile() {
  ...
  Future<void> getCodeWithPhoneNumber(
    ...
    return _$getCodeWithPhoneNumberAsyncAction.run(
        () => super.getCodeWithPhoneNumber(context, countryCode, phoneNumber));
  }
