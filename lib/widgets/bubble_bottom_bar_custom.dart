...
const double _kActiveFontSize = 18.0;
                ...
                child: Stack(
                  children: <Widget>[
                    InkResponse(
                      ...
                      child: Container(
                        width: selected
                            ? /* 105 */ MediaQuery.of(context).size.width / 4.3
                        ...
                        decoration: BoxDecoration(
                            ...
                            color: selected
                                ? Colors
                                    .white //item.backgroundColor.withOpacity(opacity)
                                : Color.fromRGBO(
                                    250, 250, 250, 1), // Colors.transparent,
